export default {
  ...
  imBaseURL: import.meta.env.DEV
    ? "http://localhost:81/im/"
    : location.protocol + "//" + location.host + "/im",

  // 前台URL（用于跨应用跳转，如登录页、文章详情页）
  // 开发环境通过环境变量配置，生产环境与后台同域
  frontendURL: import.meta.env.DEV
    ? `http://localhost:5173`
    : location.protocol + "//" + location.host,
